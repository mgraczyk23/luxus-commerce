...
export const TermsPolicy: GlobalConfig = {
  slug: 'terms-policy',
  label: 'Terms & Conditions',
  admin: {
    description: 'Edit the content of the Terms & Conditions page. Changes publish instantly.',
    group: 'Policy Pages',
  },
  access: { read: () => true },
  hooks: {
    afterChange: [async () => { await revalidate('policy-terms') }],
  },
  fields: [
    {
      name: 'lastUpdated',
