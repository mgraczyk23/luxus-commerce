...
export const ConsignmentPage: GlobalConfig = {
  ...
  fields: [
    ...
    { name: 'option1Link',    type: 'text',     label: 'Option 1 — Link URL (optional)', admin: { description: 'If set, the heading becomes a clickable link. Use a relative path like /classifieds or a full URL.' } },
    { name: 'option2Heading', type: 'text',     label: 'Option 2 — Heading (Private Sale)' },
    { name: 'option2Body',    type: 'textarea', label: 'Option 2 — Body' },
    { name: 'option2Link',    type: 'text',     label: 'Option 2 — Link URL (optional)', admin: { description: 'If set, the heading becomes a clickable link.' } },
