...
export const PageSeo: GlobalConfig = {
  ...
  fields: [
    ...
    pageGroup('models',             'Shop by Model  ( /shop/models )'),
    pageGroup('collectibleFirearms','Collectible Firearms  ( /shop/collectible-firearms )'),
    pageGroup('modernFirearms',     'Modern Firearms  ( /shop/modern-firearms )'),
    pageGroup('featured',           'Featured Collection  ( /featured )'),
    pageGroup('shipping',           'Shipping & Returns  ( /shipping )'),
    pageGroup('terms',              'Terms & Conditions  ( /terms )'),
    pageGroup('privacy',            'Privacy Policy  ( /privacy )'),
  ],
}
